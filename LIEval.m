    ...
    for i = 1:length(hours)
        for iii = 1:length(n_plates.x6144plate_1)
            bg1 = fetch(conn, sprintf(['select a.* ',...
                ...
                'and b.%s = %d ',...
                'order by b.%s, b.%s'],...
                expt1,p2c_info(1,:),hours,p2c_info(2,:),...
                iii,p2c_info(3,:),p2c_info(4,:)));
            ...
            bg2 = fetch(conn, sprintf(['select a.* ',...
                ...
                'and b.%s = %d ',...
                'order by b.%s, b.%s'],...
                expt2,p2c_info(1,:),hours,p2c_info(2,:),...
                iii,p2c_info(3,:),p2c_info(4,:)));
...
%                 'and b.%s = %d ',...
%                 'order by b.%s, b.%s'],...
%                 expt3,p2c_info(1,:),hours,p2c_info(2,:),...
%                 iii,p2c_info(3,:),p2c_info(4,:)));
...
%         rmse3 = rmse3(~isnan(rmse3));
        ...
        better{i} = [ranksum(rmse1,rmse2,'tail','right'), ranksum(rmse1,rmse2,'tail','left')];
    end
