...
%   Preset Inputs:
%       sql info (username, password, database name) --> Saurin's
%   Inputs Required:
%       experiment name,
...
%%  ANALYZE DATA
    ...
    if density <= 384
        image2spatial_LD(files, hours, dimensions,...
            p2c, tablename_raw, tablename_spa, tablename_bpos)
    else
%%  Load Analyzed Data
