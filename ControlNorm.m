...
%%
    ...
    %         SM = SpatialMedianControlNorm('window',9);
        ...
        elseif density == 1536
            SM = SpatialMedianControlNorm('window',9); 
            for ii = 1:length(hours)
                for iii = 1:length(n_plates.x1536plate_1)
                    pos.all = fetch(conn, sprintf(['select a.pos ',...
                        'from %s a ',...
                        'where %s = %d ',...
                        'order by %s, %s'],...
        ...
        elseif density == 384
            SM = SpatialMedianControlNorm('window',6); 
            for ii = 1:length(hours)
                for iii = 1:length(n_plates.x384plate_1)
                    pos.all = fetch(conn, sprintf(['select a.pos ',...
                        'from %s a ',...
                        'where %s = %d ',...
                        'order by %s, %s'],...
            ...
            SM = SpatialMedianControlNorm('window',3); 
            for ii = 1:length(hours)
                for iii = 1:length(n_plates.x96plate)
                    pos.all = fetch(conn, sprintf(['select a.pos ',...
                        'from %s a ',...
                        'where %s = %d ',...
                        'order by %s, %s'],...
